...
//	ON_COMMAND(IDD_CODEVIEW_POPUP1, &CMainFrame::OnIddCodeviewPopup1)
	ON_WM_CONTEXTMENU()
//	ON_COMMAND(ID_EDIT_TABNAME, &CMainFrame::OnEditTabname)
END_MESSAGE_MAP()
...
//void CMainFrame::OnIddCodeviewPopup1()
//{
